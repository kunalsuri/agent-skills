...
The **Agent-Skills** project is open-source and licensed under the [Apache License 2.0](LICENSE) — Copyright © 2026 Kunal Suri ([@kunalsuri](https://github.com/kunalsuri)) (CEA LIST).
